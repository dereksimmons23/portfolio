...
const CV = () => {
  ...
  return (
    <div>
      <ReactToPrint
        trigger={() => (
          <Button className="absolute top-4 right-4 print:hidden bg-blue-500 text-white hover:bg-blue-600">
      ...
      />
      <Card ref={componentRef} className="w-full max-w-4xl relative print:shadow-none bg-white">
          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              ...
              <p className="text-gray-600">
                derek@flinthills.io • flinthills.io • linkedin.com/in/dereksimm
              </p>
            </div>
            <img
              src="/assets/qr-headshot.png"
              alt="Contact QR Code with Derek Simmons headshot"
  ...
  <div className="space-y-8">
    <section>
      ...
      <p className="text-gray-700">
        Pattern recognition specialist integrating human wisdom with technological advancement.
        Pioneered AI ethics frameworks while leading enterprise-wide transformation. Founded The CW
        Standard, combining traditional pattern recognition with modern AI capabilities. Proven
        success translating insights across domains - from coaching athletics to leading AI
        integration, from visual journalism to digital transformation.
      </p>
    </section>
    ...
    <section>
      ...
      <div className="space-y-6">{/* Experience items remain the same */}</div>
    </section>
  ...
  <div className="space-y-6">
    <section className="border rounded-lg p-6 bg-gray-50">
      ...
      <p className="text-gray-600 mb-4">
        Framework for natural development and pattern recognition
      </p>
